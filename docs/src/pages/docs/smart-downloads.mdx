...
Smart Downloads relies on the library update check to detect new chapters. Configure the update interval in:

**More > Settings > Library > Update Interval**

- Set to **0** for manual-only updates (pull-to-refresh)
- Or set an interval in hours (e.g., 12 hours)
